        ...
        <div class="panel-heading">Class Add</div>
          <div class="panel-body">
           ...
           foreach ($rows as $r) 
           {
            ...
            <form action="../handling/EditDocument.php?id=<?=$r['Id']?>" method="post" enctype="multipart/form-data">
            <?php } ?>
            <div class="form-group">
              ...
              <td>
                <select class="form-control" id="exampleFormControlSelect1" name="Id_class" >
                  ...
                  $id=$_GET['id'];
                  $sql = "Select class.id , class.name FROM class INNER JOIN document ON class.id=document.Id_class where document.Id = $id  ";
             ...
             foreach ($rows as $r) 
             {
              ...
              <div class="form-group">
                <label >Title:</label>
                <input type="text" class="form-control" placeholder="Title" name="Title" value="<?=$r['Title']?>" required>
              </div>
              ...
              <div class="form-group">
                ...
                <textarea  rows="10" cols="99" name="Content" style="color: black"><?=$r['Content']?>
                </textarea>
            ...
            <div class="input-group">
              <input type="submit" class="btn btn-success" name="update_document" id="update_document" value="Update">
            </div>
