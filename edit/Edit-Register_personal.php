      ...
      <ul>
        ...
        <div class="user_Profile">
          <i class="fa fa-user"></i>
            ...
            <div class=" w3-col s12 w3-dropdown-content w3-bar-block w3-border">
              ...
              <div class="<?php echo $_SESSION['permision'] == "Personal" ? 'show' : 'hidden';?>"><a class="w3-bar-item w3-button" href="../view/DashbordOfPersonal.php"><i class="fa fa-bar-chart-or"></i> Dashbord</a></div>
      ...
      <div class="panel panel-default">
        <div class="panel-heading">Register Add</div>
          <div class="panel-body">
            ...
            <form action="../handling/handingregisterPersonal.php?id=<?=$r['id']?>" method="post" enctype="MULTIPLE/form-data">
