      ...
      <div class="panel panel-default">
        <div class="panel-heading">Class Add</div>
          <div class="panel-body">
            <form action="../handling/AddClass.php" method="post" enctype="MULTIPLE/form-data">
              <div class="form-group">
                <label >Name Class:</label>
                <input type="text" class="form-control" placeholder="Name Class" name="name" required>
              </div>  
              <div class="form-group">
           ...
           <input type="submit" class="btn btn-success" name="add_Class" id="add_Class" value="Add">
           </div>
         </form>
       </div>
     </div>
