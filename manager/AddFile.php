      ...
      <div class="panel panel-default">
        <div class="panel-heading">Class Add</div>
          <div class="panel-body">
            <form action="../handling/handlingDocument.php" method="POST" enctype="MULTIPLE/form-data"> 
              ...
              <?php
              if (isset($_POST['up']) && isset($_FILES['Document'])) {
                if ($_FILES['Document']['error'] > 0)
                  echo "Upload lỗi rồi!";
                else {
                  move_uploaded_file($_FILES['Document']['tmp_name'], '../handling/upload/' . $_FILES['Document']['name']);
