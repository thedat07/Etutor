  ...
  <div class="main_container">     
    <div class="item">
      <div class="panel panel-default">
        <div class="panel-heading">Courses Add</div>
          <div class="panel-body">
            <form action="../handling/handlingCourse.php" method="post" enctype="MULTIPLE/form-data">
                <div class="form-group">
                  <label >Name:</label>
                  <input type="text" class="form-control" placeholder="Name Courses" name="name_Courses" required>
                </div>
                <div class="form-group">
                  <label for="comment">Descriptions:</label>
                  <textarea class="form-control" rows="5" cols="65" id="comment" name="descriptions_Courses"></textarea>
                </div>   
                <div class="form-group">
                  ...
                  <td>
                    <select class="form-control" id="exampleFormControlSelect1" name="id_Courses_categories">
                      ...
                      foreach($rows as $r) {
                       ?>
                       <option value="<?=$r['id_Courses_categories']?>" selected><?=$r['name_category']?></option>
                     <?php }?>
                   </select>                
                 </td>
               </div>
               <div class="input-group">          
                  <input type="submit" class="btn btn-success" name="add_Courses" id="add_Courses" value="Add">
                </div>
            </form>
       </div>
     </div>
