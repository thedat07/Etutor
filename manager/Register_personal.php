    ...
    <div class="item">
      <div class="panel panel-default">
        <div class="panel-heading">Register Add</div>
          ...
          <form action="../handling/handingregisterPersonal.php" method="post" enctype="MULTIPLE/form-data">
            ...
            <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control"  name="id_Trainer"  required>
              </div>
            </div>   
          <div class="input-group ">   
            <input type="submit" class="btn btn-success " name="add_Register" id="add_Register" value="Add">
          </div>
          </form>
