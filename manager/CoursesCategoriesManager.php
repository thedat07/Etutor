...
<head>
  <meta charset="UTF-8">
  <title>Course Category Manager</title>
  ...
  <div class="main_container">     
    <div class="item">
      <div class="panel panel-default">
        <div class="panel-heading">Courses categories add</div>
        <div class="panel-body">
          <form action="../handling/handlingCoursesCategoriesManager.php" method="post" enctype="MULTIPLE/form-data">
            <div class="form-group">
              <label >Name category:</label>
              <input type="text" class="form-control" placeholder="Education" name="name_category" required>
            </div>
            <div class="form-group">
              <label for="comment">Descriptions:</label>
              <textarea class="form-control" rows="5" cols="65" id="comment" name="descriptions_Courses_categories"></textarea>
            </div>
            <div class="input-group">            
              <input type="submit" class="btn btn-success"  name="add_Courses_categories" id="add_Courses_categories" value="Add">
            </div>
          </form>
        </div>
      </div>
