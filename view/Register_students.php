  ...
  <div class="main_container">
    ...
    <div class="item">
      ...
      <div class="w3-container" >
        ...
        <form class="form-inline md-form form-sm mt-0" action="Register_students.php" method="post">
          ...
          <a href="../manager/Register_students.php" class="btn btn-info" role="button">Add</a>
        </form>
        &nbsp;                               
        <table class="w3-table-all w3-hoverable ">
          ...
          <tbody>
            ...
            if(isset($_POST['search'])) {
              ...
              $sql="Select * from users where username like  '%".$valueToSearch."%' and permision='Student' ";
              $rows = $cn->runQuery($sql);
            }
            else{
              $sql="Select * from users where permision='Student'";
              $rows = $cn->runQuery($sql);}
              foreach ($rows as $r) {
                ?>         
                <tr>
