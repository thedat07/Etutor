    ...
    <div class="item">
      ...
      <div class="w3-container" >
        ...
        <form class="form-inline md-form form-sm mt-0" action="Register_personal.php" method="post">
          ...
          <a href="../manager/Register_personal.php" class="btn btn-info" role="button">Add</a>
        </form>
        &nbsp;                               
        <table class="w3-table-all w3-hoverable ">
          ...
          <tbody>
            ...
            if(isset($_POST['search'])) {
              ...
              $sql="Select * from users where username like  '%".$valueToSearch."%' and permision='Personal' ";
              $rows = $cn->runQuery($sql);
            }
            else{
              $sql="Select * from users where permision='Personal'";
              $rows = $cn->runQuery($sql);}
              foreach ($rows as $r) {
                ?>         
                <tr>
...
<<<<<<< HEAD
                    <a href="../view/DashbordOfPersonal.php?id=<?=$r['id_tutor']?>" class="View" title="Dashboard" data-toggle="tooltip">
=======
