    ...
    <div class="item">
				...
				<div class="w3-container" >
					<form class="form-inline md-form form-sm mt-0" action="Register_personal.php" method="post">
						<a href="../manager/AddDocument.php?id=<?=$r['id']?>" class="btn btn-info" role="button">Add document</a>
					<?php } ?>
					...
					<tbody>
						...
						foreach ($rows as $r) {
							...
							<tr>
								...
								<td><?=$r['Time']?></td>
								<td>
									<a href="../edit/Edit-AddDocument.php?id=<?=$r['Id']?>" class="Edit" title="Edit" data-toggle="tooltip">
										<i class="material-icons">edit</i>
									</a>
									<a href="../view/ViewStudent.php?id=<?=$r['Id']?>&Id_class=<?=$r['Id_class']?>" class="Student submit" title="Student submit" data-toggle="tooltip">
										<i class="material-icons">people_alt</i>
									</a>  
									<a href="../handling/handlingDocument.php?id=<?=$r['Id']?>&Id_class=<?=$r['Id_class']?>" class="Delete" title="Delete" data-toggle="tooltip">
				...
				$id=$_GET['id'];
				$sql="INSERT INTO log(id_Trainer ,id_Class) VALUES ('".$id_Trainer."','".$id."')";
				$cn = new DBConnector();
