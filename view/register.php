  ...
  <div class="main_container">
    ...
    <div class="item">
      <div class="panel panel-default">
        <div class="panel-heading">Permision show</div>
      </div>
      <div class="w3-container" >

        <form class="form-inline md-form form-sm mt-0" action="register.php" method="post">
          ...
          <a href="../manager/register.php" class="btn btn-info" role="button">Add</a>
        </form>
        &nbsp;                               
        <table class="w3-table-all w3-hoverable ">
          ...
          <tbody>
            ...
            if(isset($_POST['search'])) {
              ...
              $sql="Select * from users where username like  '%".$valueToSearch."%' and permision='Admin' ";
              $rows = $cn->runQuery($sql);
            }
            else{
              $sql="Select * from users where permision='Admin'";
              $rows = $cn->runQuery($sql);}
              foreach ($rows as $r) {
                ?>         
                <tr>
                  ...
                  <td><?=$r['permision']?></td>
                  <td>
                    <a href="../edit/Edit-register.php?id=<?=$r['id']?>" class="Edit" title="Edit" data-toggle="tooltip">
                      <i class="material-icons">edit</i>
                    </a>
                    <a href="../handling/handingregister.php?id=<?=$r['id']?>" class="Delete" title="Delete" data-toggle="tooltip">
