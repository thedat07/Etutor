    ...
    <div class="item">
      ...
      <div class="w3-container" >
        ...
        <form class="form-inline md-form form-sm mt-0" action="Class.php" method="post">
          <input class="form-control form-control-sm ml-3 w-75" type="text" placeholder="Search name class" aria-label="Search name class" id="search" name="valueToSearch">
          <input type="submit" class="btn " name="search" id="search" value="Search">
          <a href="../manager/AddClass.php" class="btn btn-info" role="button">Add</a>
        </form>
        &nbsp;                               
            ...
            if(isset($_POST['search'])) {
              ...
              foreach ($rows as $r) {
                ...
                <tr>
                  ...
                  <td>
                    <a href="../edit/Edit-AddClass.php?id=<?=$r['id']?>" class="Edit" title="Edit" data-toggle="tooltip">
                      <i class="material-icons">edit</i>
                    </a> 
                    <a href="../handling/handlingClass.php?id=<?=$r['id']?>" class="Delete" title="Delete" data-toggle="tooltip">
